				...
				<div class="row-fluid">
					<div class="span12">
						...
						<div class="portlet box grey">
							...
							<table id="dg" name="dg" class="easyui-datagrid" title="Footer Rows in DataGrid" style="width:700px;height:220px">
						        <thead>
						            <tr>
						                <th data-options="field:'id',width:80">id</th>
						                <th data-options="field:'name',width:80">name</th>
						                <th data-options="field:'path',width:120,align:'left'">path</th>
